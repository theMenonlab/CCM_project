...
PARAMS = {
    ...
    'dir': 'large-neuron', # Head directory inside datasets folder. Should contain ccm folder and ref folder if evaluating.
    'num_channels': 1, 'raw_input_shape': (338,338), 'target_input_shape': (338,338),

    'chpt': get_and_increment_chpt_num(),
    'channel_format': 'NCHW',

    'load_chpt': 77, # Presaved model checkpoint

    'evaluate': True,  # Set to false if no ground truth CCM images
    'num_images_to_generate': 200,
    'start_ds_index': 30400, # CCM jpeg image start index, e.g. start_ds_index = 30400 with num_images_to_generate = 200 will use input ccm/30400.jpeg, ..., ccm/30599.jpeg
